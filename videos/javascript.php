               ...
               <div class="row">
                  <div class="col-md-12">
                     ...
                     <div class="heading_main text_align_center">
                           <h4 style="color: brown;">Welcome here!</h4>
                     </div>
                        <div class="heading_main text_align_center">
                           <h2>Free Course</h2>
                        </div>
               ...
               <div class="row">
                  <div class="col-xs-11 col-sm-4 col-md-4 col-lg-10 offset-lg-1">
                     <div class="full feature_box">
                         <div class="full icon">
                            <img  src="images/icons8-javascript (3).svg" alt="#" />
                         ...
                         <div class="full">
                           <p>JavaScript is the world's most popular programming language.JavaScript is easy to learn.This tutorial will teach you JavaScript from basic to advanced.</p>
                         </div>
                     </div>
                  </div>
         ...
         <div class="section about_section layout_padding padding_top_0">
            <div class="container">
                  ...
                  <div class="col-md-12">
                     <div class="full">
                        <div class="heading_main text_align_center margin-bottom_30">
                           <h2><strong class="small theme_color"> Watch JAVASCRIPT COURSE</strong><br></h2>
                        </div>
                     </div>
                  </div>
               ...
               <div class="full center">
                        <a class="readmore_bt" href="#">JAVASCRIPT COURSE</a>
                      </div>
               <div class="row">
                  <div class="col-md-12">
                     ...
                     $selectquery= "select * from addvideo where id=9";
