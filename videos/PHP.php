               ...
               <div class="row">
                  <div class="col-xs-11 col-sm-4 col-md-4 col-lg-10 offset-lg-1">
                     <div class="full feature_box">
                         <div class="full icon">
                            <img  src="images/php-ar21 (1).svg" alt="#" />
         ...
         <div class="section about_section layout_padding padding_top_0">
            <div class="container">
                  ...
                  <div class="col-md-12">
                     <div class="full">
                        <div class="heading_main text_align_center margin-bottom_30">
                           <h2><strong class="small theme_color"> Watch PHP COURSE</strong><br></h2>
                        </div>
                     </div>
                  </div>
               ...
               <div class="full center">
                        <a class="readmore_bt" href="#">PHP COURSE</a>
                      </div>
               <div class="row">
                  <div class="col-md-12">
                     ...
                     $selectquery= "select * from addvideo where id=10";
